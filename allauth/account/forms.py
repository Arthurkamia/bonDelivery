...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password'].widget = forms.PasswordInput(attrs={'class': 'form-control p-4', 'label': _("Password"), 'autocomplete': _("current-password"), 'placeholder': 'Password'})
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username"), "autocomplete": "username", "class": "form-control p-4",}
            )
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username or e-mail"), "autocomplete": "email", "class": "form-control p-4",}
            )
            login_field = forms.CharField(
...
class SignupForm(BaseSignupForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].widget = forms.PasswordInput(
            attrs={'class': 'form-control p-4', 'label': "Password", 'placeholder': 'Password'})

        self.fields['password2'].widget = forms.PasswordInput(
            attrs={'class': 'form-control p-4', 'label': "Password", 'placeholder': 'Password again'})
